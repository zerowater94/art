define([ 'basicInfo'
         , 'text!app/base/system/userList.html'
       ], function ( $a, _tmpl) {
	...
	var userApp = $a.ctl({
		...
		checkDupLoginId : function() {
			...
			var param = {
				url : $a.getDefaultUrl()+"/base/system/user/loginid/aaaaa",
				type : "get",
				data : {
					siteId : "PUBLIC"
				},
		...
		searchUserList : function() {
			var _self = this;
			$a.send({
				url : $a.getDefaultUrl()+"/base/system/user/list",
				type : "get",
				data : {
					siteId : "PUBLIC"
				},
		...
		saveUser : function() {
			...
			$a.send({
				url : $a.getDefaultUrl()+"/base/system/user",
